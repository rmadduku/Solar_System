...
double viewDirection = PI; // Rotation of view around y-axis (in radians)
...
double animateIncrement = 0.1;   // Make bigger to speed up animation, smaller to slow it down.
...
#if 1
const double Xmax = 20.0;                // Control x dimensions of viewable scene
const double Ymax = 20.0;                // Control y dimensions of viewable scene
const double Zmin = -80000.0, Zmax = 40000.0;   // Control z dimensions of the viewable scene

// zDistance equals the initial distance from the camera to the z = Zmax plane
const double zDistance = 20000.0;              // Make this value larger or smaller to affect field of view.

double ZextraDistance = 0.0;              // Extra distance we have moved to/from the scene
double ZextraDelta = 800;                // Pressing HOME/END moves closer/farther by this amount
const double ZextraDistanceMin = -80000.0;
const double ZextraDistanceMax = 40000.0;
int screenWidth = 800, screenHeight = 600;     // Width and height in pixels. Initially 800x600
#else
const double Xmax = 20.0;                // Control x dimensions of viewable scene
const double Ymax = 20.0;                // Control y dimensions of viewable scene
const double Zmin = -80.0, Zmax = 40.0;   // Control z dimensions of the viewable scene

// zDistance equals the initial distance from the camera to the z = Zmax plane
const double zDistance = 200.0;              // Make this value larger or smaller to affect field of view.

double ZextraDistance = 0.0;              // Extra distance we have moved to/from the scene
double ZextraDelta = 40;                // Pressing HOME/END moves closer/farther by this amount
const double ZextraDistanceMin = -1000.0;
const double ZextraDistanceMax = 800.0;
int screenWidth = 800, screenHeight = 600;     // Width and height in pixels. Initially 800x600
#endif
...
int main() {
    ...
    printf("Press 'Y' key to speed up animation.\n");
    printf("Press 'U' key to slow down animation.\n");
